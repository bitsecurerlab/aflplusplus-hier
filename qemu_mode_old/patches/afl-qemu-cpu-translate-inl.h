...
static void afl_gen_fncov(target_ulong next_eip, TCGv fn_loc){

  if (afl_use_multi_level_cov) {

    if (next_eip < afl_start_code || next_eip > afl_end_code)
      return;

    gen_helper_afl_fncov(fn_loc);
...
static void afl_gen_cmpcov(target_ulong cur_loc, TCGv arg1, TCGv arg2,
                            TCGMemOp ot) {
  ...
  if (afl_use_multi_level_cov) {
    ...
    switch (ot & MO_SIZE) {
      ...
      case MO_64:
        gen_helper_afl_cmpcov_64(cur_loc_v, arg1, arg2);
        break;
      case MO_32:
        gen_helper_afl_cmpcov_32(cur_loc_v, arg1, arg2);
        break;
      case MO_16:
        gen_helper_afl_cmpcov_16(cur_loc_v, arg1, arg2);
        break;
      default:
        gen_helper_afl_cmpcov_8(cur_loc_v, arg1, arg2);
        break;
...
// static void afl_gen_memcov(target_ulong cur_pc, TCGv mem_loc){

//   if (afl_use_multi_level_cov) {

//     if (cur_pc < afl_start_code || cur_pc > afl_end_code)
//       return;

//     TCGv cur_pc_v = tcg_const_tl(cur_pc);

//     gen_helper_afl_memcov(cur_pc_v, mem_loc);

//     tcg_temp_free(cur_pc_v);
