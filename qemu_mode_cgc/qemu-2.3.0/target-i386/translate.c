...
{
    // gen_helper_maybe_log_ma(a0, tcg_const_tl(cur_pc), tcg_const_i32(0));
    tcg_gen_qemu_ld_tl(t0, a0, s->mem_index, idx | MO_LE);
}

static inline void gen_op_st_v(DisasContext *s, int idx, TCGv t0, TCGv a0)
{
    // gen_helper_maybe_log_mw(tcg_const_tl(cur_pc), a0, t0);
    // gen_helper_maybe_log_ma(a0, tcg_const_tl(cur_pc), tcg_const_i32(1));
...
static inline void gen_jcc1(DisasContext *s, int b, TCGLabel *l1)
{
    ...
    if (cc.use_reg2) {
        gen_helper_maybe_log_brcond(tcg_const_tl(cur_pc), tcg_const_tl(cc.cond), cc.reg, cc.reg2);
        tcg_gen_brcond_tl(cc.cond, cc.reg, cc.reg2, l1);
    } else {
        gen_helper_maybe_log_brcond(tcg_const_tl(cur_pc), tcg_const_tl(cc.cond), cc.reg, tcg_const_tl(cc.imm));
        tcg_gen_brcondi_tl(cc.cond, cc.reg, cc.imm, l1);
    }
}
                           ...
                           target_ulong val, target_ulong next_eip)
{
    ...
    if (s->jmp_opt) {
        ...
        gen_helper_maybe_log_edge(tcg_const_tl(next_eip), tcg_const_tl(cur_pc));

        gen_goto_tb(s, 0, next_eip);

        gen_set_label(l1);

        gen_helper_maybe_log_edge(tcg_const_tl(val), tcg_const_tl(cur_pc));
 ...
 reswitch:
    ...
    case 0xff: /* GRP5 */
        ...
        case 2: /* call Ev */
            ...
            gen_helper_update_calling_context(cpu_T[1], cpu_T[0]);

            gen_op_jmp_v(cpu_T[0]);

            gen_helper_maybe_log_edge(cpu_T[0], tcg_const_tl(cur_pc));
        ...
        do_lcall:
        {
            ...
            gen_helper_update_calling_context(tcg_const_tl(s->pc - s->cs_base), cpu_T[1]);
            gen_helper_maybe_log_edge(cpu_T[1], tcg_const_tl(cur_pc));
        ...
        do_ljmp:
            ...
            gen_helper_maybe_log_edge(tmpTo_2, tcg_const_tl(cur_pc));
    ...
    case 0xe8: /* call im */
        {
            ...
            gen_helper_update_calling_context(cpu_T[0], tcg_const_tl(tval));            
